...
final class OnboardingState {
    ...
    /// Session-only. Last-chance persist retries after a failed write this session.
    /// Matching Auth metadata (including a cold start) skips the network.
    var firstNamePersistFailedThisSession = false
