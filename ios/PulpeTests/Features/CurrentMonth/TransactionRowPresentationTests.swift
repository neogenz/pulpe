...
@Suite("Transaction row presentation")
struct TransactionRowPresentationTests {
    ...
    func outOfPlanMarker_whenFree_statesIt() {
        ...
        #expect(TransactionRow.outOfPlanMarker(for: free) == "Hors prévision")
    }
    ...
    func outOfPlanMarker_whenAllocated_returnsNil() {
        ...
        #expect(TransactionRow.outOfPlanMarker(for: allocated) == nil)
    }
