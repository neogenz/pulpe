...
> **Per-platform scale:** the size scale, line heights, and tracking values live in the platform-specific docs (`ios/DESIGN.md`, `android/DESIGN.md`, `frontend/DESIGN.md`, `landing/DESIGN.md`). The font *family* commitments above are universal.
