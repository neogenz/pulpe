...
const FEATURES = [
  ...
  },
  {
    ...
    screenshot: {
      src: '/landing/screenshots/responsive/modal-ajout-transaction.png',
      desktopSrc: '/landing/screenshots/webapp/modal-ajout-transaction.png',
  ...
  },
  {
    ...
    screenshot: {
      src: '/landing/screenshots/responsive/liste-des-previsions.png',
      desktopSrc: '/landing/screenshots/webapp/liste-des-previsions.png',
  ...
  },
  {
    ...
    screenshot: {
      src: '/landing/screenshots/responsive/ecran-des-modeles.png',
      desktopSrc: '/landing/screenshots/webapp/ecran-des-modeles.png',
