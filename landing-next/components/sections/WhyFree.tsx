      ...
      <div className="max-w-3xl mx-auto">
        ...
        <FadeIn delay={0.3}>
          <div className="flex flex-wrap gap-4 justify-center mt-8 text-sm">
            ...
            <a href="/landing/legal/cgu" className="text-accent hover:underline">CGU</a>
            <a href="/landing/legal/confidentialite" className="text-accent hover:underline">Confidentialité</a>
          </div>
        </FadeIn>
      </div>
    </Section>
