...
| Un composant `Notice` unique remplace les treize `<Snackbar>` nus                                | Le fond, la couleur d'encre et la garde au-dessus du FAB sont la même décision répétée treize fois ; corriger le thème global aurait fait mentir le rôle MD3 `inverseSurface` |
