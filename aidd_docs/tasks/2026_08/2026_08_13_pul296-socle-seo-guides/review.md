...
- [x] Landing contracts fail on a second H1, CTA drift, divergent FAQ schema, or page-to-registry mismatch — `landing/components/guides/ArticleLayout.test.tsx:44-261`
...
- [x] The seed article has one H1, a direct answer, sourced figures, visible FAQ content equal to `FAQPage`, and one CTA — `landing/app/conseils-budget/comment-faire-son-budget-en-suisse/page.tsx:27-253`, `landing/components/guides/ArticleLayout.tsx:58-158`
- [x] The static export has the expected title, description, canonical, and server-rendered article content without client JavaScript — verified in `landing/dist/conseils-budget.html` and `landing/dist/conseils-budget/comment-faire-son-budget-en-suisse.html`
...
- [x] The root graph defines one Organization without unsupported `sameAs` claims, and site/article nodes reference it by `@id` — `landing/app/layout.tsx:151-190`, `landing/components/guides/ArticleLayout.tsx:57-61`
...
- [x] Organization claims, article interaction states, pull-quote semantics, and JSON-LD assertion scope are accurate and regression-tested — `landing/app/globals.css:606-617`, `landing/components/guides/ArticleLayout.test.tsx:63-77`, `landing/components/guides/ArticleLayout.test.tsx:148-175`
- [x] PR-added developer documentation is English; PR #602 metadata uses the final route, all review threads are resolved, and GitHub reports `MERGEABLE`/`CLEAN`.
...
| Unchecked     | none                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Unplanned     | Broader growth-plan source retained and translated (6 files); PUL-304 measurement notes; three-column footer regrouping and test; support “Tutoriels” terminology and tests; header/sentinel navigation-lifecycle hardening and tests; `IOS_APP_URL` centralization and config normalization; Node mock migration to `exports.default`; accessible table caption; legacy Safari table-border fallback; readonly guide registry — reviewed as coherent supporting changes |
