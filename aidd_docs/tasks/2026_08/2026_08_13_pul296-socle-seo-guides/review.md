...
| Unchecked     | none                                                                                                                                                                                                                                                                                                                                                                             |
| Unplanned     | Broader growth-plan source retained and translated (6 files); PUL-304 measurement notes; three-column footer regrouping and test; support “Tutoriels” terminology and tests; header/sentinel navigation-lifecycle hardening and tests; `IOS_APP_URL` centralization and config normalization; Node mock migration to `exports.default` — reviewed as coherent supporting changes |
