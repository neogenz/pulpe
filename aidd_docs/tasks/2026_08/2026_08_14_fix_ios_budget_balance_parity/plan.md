...
| Field      | Value |
| ---------- | ----- |
| **Goal**   | Invalider les projections iOS devenues obsolètes lorsqu’une modification du Mois Type change des budgets existants. |
| **Source** | Signalement utilisateur du 14 août 2026 et captures jointes `IMG_5235.PNG` et `IMG_5236.PNG`. |
...
| 3   | Aligner le seam sur PUL-270 | [`phase-3.md`](./phase-3.md) |
