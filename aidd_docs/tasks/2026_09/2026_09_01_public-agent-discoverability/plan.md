...
| https://developers.google.com/search/docs/appearance/structured-data/article | Google strongly recommends an `author.url` or `author.sameAs` value that uniquely identifies each article author.                                                               |

## Decisions

| Decision                                                                                                                                               | Why                                                                                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Keep landing changes limited to concrete engine diagnostics or current first-party guidance that exposes a missing identity field.                     | The existing technical baseline passes; only the article author's missing `/about` identity link is evidenced by current Google guidance.                                      |
