...
- `schemas.ts` : contrats HTTP Zod et types inférés ;
- `src/calculators/` : formules métier pures ;
- `src/currency*.ts` : devises, conversion et formatage ;
- `src/feature-flags.ts` : flags et contrat analytics ;
- `index.ts` : unique surface publique du package.
