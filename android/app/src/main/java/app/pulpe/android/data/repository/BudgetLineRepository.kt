...
class BudgetLineRepository @Inject constructor(
    ...
    suspend fun getBudgetLines(budgetId: String): Result<List<BudgetLine>> = withContext(ioDispatcher) {
        try {
    ...
    suspend fun createBudgetLine(line: BudgetLineCreate): Result<BudgetLine> = withContext(ioDispatcher) {
        try {
    ...
    suspend fun updateBudgetLine(id: String, update: BudgetLineUpdate): Result<BudgetLine> = withContext(ioDispatcher) {
        try {
    ...
    suspend fun deleteBudgetLine(id: String): Result<Unit> = withContext(ioDispatcher) {
        try {
    ...
    suspend fun toggleCheck(id: String): Result<BudgetLine> = withContext(ioDispatcher) {
        try {
    ...
    suspend fun resetFromTemplate(id: String): Result<BudgetLine> = withContext(ioDispatcher) {
        try {
