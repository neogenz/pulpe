...
| `security_definer_function_privileges.sql`            | exposed RPC modes and grants               | exact 15-function inventory, legacy plan entry point closed to authenticated callers, internal plan/withdrawal helpers inaccessible, future function execution opt-in                                                       |
