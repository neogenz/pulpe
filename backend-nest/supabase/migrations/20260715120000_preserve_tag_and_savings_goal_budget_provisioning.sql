-- PUL-18 + PUL-12 — preserve both template-line link families when a budget
-- is materialized. The preceding branch-specific migration intentionally
-- removed tag propagation before the tag tables existed on preview; after the
-- branches merge, create_budget_from_template must copy both links.
