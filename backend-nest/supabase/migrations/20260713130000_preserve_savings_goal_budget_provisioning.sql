-- PUL-12 — restore the branch-owned create_budget_from_template contract.
--
-- The preceding hardening migration accidentally folded in tag-copying from
-- PUL-18. Those tables are not owned by this branch. Keep provisioning scoped
-- to PUL-12 while preserving savings-goal and currency propagation.
