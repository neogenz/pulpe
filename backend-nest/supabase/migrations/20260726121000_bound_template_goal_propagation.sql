-- PUL-312 — bound each newly propagated savings-goal line to its own horizon.
--
-- `excluded_budget_ids` is optional per created line. It only filters new
-- budget_line INSERTs; existing occurrences keep receiving template updates,
-- including occurrences after the goal deadline.
