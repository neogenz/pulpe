...
describe('BudgetLineService', () => {
  ...
  describe('update', () => {
    ...
    it('should set isManuallyAdjusted to true when updating', async () => {
      const budgetLineId = '123e4567-e89b-12d3-a456-426614174000';
      ...
      // Verify the update data includes is_manually_adjusted
      ...
      // Verify the response includes isManuallyAdjusted as true
      expect(result.data.isManuallyAdjusted).toBe(true);
    });

    it('should not override isManuallyAdjusted if not provided', async () => {
      const budgetLineId = '123e4567-e89b-12d3-a456-426614174000';
      const updateDto: BudgetLineUpdate = {
        id: budgetLineId,
        name: 'New Name Only',
        // isManuallyAdjusted not provided
      };
      ...
      // Verify that is_manually_adjusted is NOT in the update when not provided
      expect(capturedUpdateData).not.toHaveProperty('is_manually_adjusted');
    });
  });
